...
extension Predicate where Value: Equatable {
  ...
  public static func contained<Sequence>(in values: Sequence) -> Predicate
  where Sequence: Swift.Sequence, Sequence.Element == Value {
...
extension Collection {
  ...
  public subscript(predicate: Predicate<Self.Element>) -> Element {
    get throws { first(where: predicate)! }
  }
}
